...
import com.example.getblood.Activities.PostDetailActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        //  get current user from the shared preference
        ...
        if(notificationType.equals("PostNotification"))
        {
            ...
            // If user is same that has posted don't show notfication
    ...
    private void showPostNotification(String pId, String pTitle, String pDescription) {
        ...
        /* Apps targeting  SDK 26 or above (Android o and above  ) must implement notification channels
         and its notification to at least one of them
         Let's add check if version is oreo or higher  then setup notification channel
         */

        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            setUpPostNotificationToChannel(notificationManager);
        }
        ...
        //Large Icon
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_get_blood_auncher);

        Uri notificationSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this,""+ADMIN_CHANNEL_ID)
                .setSmallIcon(R.drawable.blooddropnew)
    ...
    private void setUpPostNotificationToChannel(NotificationManager notificationManager) {
